...
> está en [README.es.md](README.es.md); cómo instalarla, en [docs/INSTALL.es.md](docs/INSTALL.es.md); qué
> cambió y cuándo, en [CHANGELOG.es.md](CHANGELOG.es.md); y lo que sigue abierto, en
> [ROADMAP.es.md](ROADMAP.es.md). Las decisiones de §1 y la tesis de §0 siguen siendo la razón de ser del
